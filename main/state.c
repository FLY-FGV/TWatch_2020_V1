...
void draw_dow(int x,int y,int dow)
{
	if (dow<0) return;
	if (dow>=7) return;
#ifdef CONFIG_DAYOFWEEK_TYPE_RUS
...
#endif
#ifdef CONFIG_DAYOFWEEK_TYPE_EN
	uint16_t DOW_IMG[7][16]={	{0x0000,0x3000,0x4800,0x4120,0x2120,0x1120,0x0920,0x4920, 0x30E0,0x00,0x00,0x00,0x00,0x00,0x00,0x00},// 0-Su
								{0x0000,0x4400,0x6C00,0x6CC0,0x5520,0x5520,0x4520,0x4520, 0x44C0,0x00,0x00,0x00,0x00,0x00,0x00,0x00},// 1-Mo
								{0x0000,0x7C00,0x1000,0x1120,0x1120,0x1120,0x1120,0x1120, 0x10E0,0x00,0x00,0x00,0x00,0x00,0x00,0x00},// 2-Tu
								{0x0000,0x4400,0x4400,0x44C0,0x5520,0x5520,0x55E0,0x5500, 0x28C0,0x00,0x00,0x00,0x00,0x00,0x00,0x00},// 3-We
								{0x0000,0x7C00,0x1100,0x1100,0x1100,0x11C0,0x1120,0x1120, 0x1120,0x00,0x00,0x00,0x00,0x00,0x00,0x00},// 4-Th
								{0x0000,0x7C00,0x4000,0x41C0,0x4120,0x7920,0x41C0,0x4120, 0x4120,0x00,0x00,0x00,0x00,0x00,0x00,0x00},// 5-Fr
								{0x0000,0x3000,0x4800,0x40C0,0x2120,0x1120,0x09E0,0x4920, 0x3120,0x00,0x00,0x00,0x00,0x00,0x00,0x00}};//6-Sa
#endif
